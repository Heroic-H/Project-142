...
# Webdriver
browser = webdriver.Chrome("C:/Users/batul/OneDrive/Desktop/My Stuff/Heroic H/Coding Classes/In Lesson/c142/chromedriver.exe")
        ...
        for tr_tag in soup.find_all("tr",attrs={"class":"fact_row"}):
            ...
            for td_tag in td_tags:
                try:
                    ...
                    temp_list.append("")
        new_planets_data.apppend(temp_list)
    except:
        time.sleep(1)
...
planet_df_1 = pd.read_csv("UpdatedScrapedData.csv")
...
# Remove '/n' character from the scraped data
scraped_data = []
